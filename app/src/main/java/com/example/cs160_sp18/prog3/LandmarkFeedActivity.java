...
public class LandmarkFeedActivity extends AppCompatActivity {
    ...
    private static final long UPDATE_INTERVAL_IN_MILLESECONDS = 10000;
    private static final long FASTEST_UPDATE_INTERVAL_IN_MILLESECONDS = UPDATE_INTERVAL_IN_MILLESECONDS / 2;
...
//        setAdapterAndUpdateData();
    ...
    private void startUpdatesHandler(View view) {
        if (!mRequestingLocationUpdates) {
            mRequestingLocationUpdates = true;
            startLocationUpdates();
        }
    }
    private void stopUpdatesHandler(View view) {
        stopLocationUpdates();
    }
...
//                        Log.i(TAG, "User chose not to make required location settings changes.");
    ...
    private void createLocationRequest() {
        ...
        mLocationRequest.setFastestInterval(FASTEST_UPDATE_INTERVAL_IN_MILLESECONDS);
